...
package com.slandete.android.apps.campussched.util;

import com.slandete.android.apps.campussched.R;
import com.slandete.android.apps.campussched.es.Setup;
import com.slandete.android.apps.campussched.es.ui.HomeActivity;
...
public class UIUtils {
	...
	public static TimeZone CONFERENCE_TIME_ZONE_DEFAULT = Setup.CONFERENCE_TIME_ZONE;

	public static TimeZone CONFERENCE_TIME_ZONE = Setup.CONFERENCE_TIME_ZONE;

	// public static final long CONFERENCE_START_MILLIS = ParserUtils.parseTime(
	// "2010-11-09T07:00:00.000+02:00");
	// public static final long CONFERENCE_END_MILLIS = ParserUtils.parseTime(
	// "2010-11-09T21:00:00.000+02:00");
...
//			.parse("http://code.google.com/events/io/2010/");
	
	public static final Uri CONFERENCE_URL = Uri
	.parse(Setup.CONFERNCE_URL);
	
	public static final Uri TV_URL = Uri
	.parse(Setup.TV_URL);
...
//			Locale.getDefault());
	...
	public static void setTitleBarColor(View titleBarView, int color) {
		...
		if (brColor > BRIGHTNESS_THRESHOLD) {
			((TextView) titleBar.findViewById(R.id.title_text))
					.setTextColor(titleBar.getContext().getResources()
							.getColor(R.color.title_text_alt));
					...
					for (int i = 0; i < childCount; i++) {
						...
						if (child instanceof ImageButton) {
							...
							if (childButton.getDrawable() != null
								...
								((LevelListDrawable) childButton.getDrawable())
										.setLevel(1);
							}
						}
					}
	...
	public static String formatSessionSubtitle(long blockStart, long blockEnd,
		...
		return context.getString(R.string.session_subtitle, timeString,
				roomName);
	}
