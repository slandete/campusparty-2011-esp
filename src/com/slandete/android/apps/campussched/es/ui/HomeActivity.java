...
package com.slandete.android.apps.campussched.es.ui;

import static com.slandete.android.apps.campussched.util.UIUtils.formatSessionSubtitle;

import com.slandete.android.apps.campussched.R;
import com.slandete.android.apps.campussched.es.Setup;
import com.slandete.android.apps.campussched.es.service.SyncService;
import com.slandete.android.apps.campussched.provider.ScheduleContract.Blocks;
import com.slandete.android.apps.campussched.provider.ScheduleContract.Notes;
import com.slandete.android.apps.campussched.provider.ScheduleContract.Rooms;
import com.slandete.android.apps.campussched.provider.ScheduleContract.Sessions;
import com.slandete.android.apps.campussched.provider.ScheduleContract.Tracks;
import com.slandete.android.apps.campussched.util.DetachableResultReceiver;
import com.slandete.android.apps.campussched.util.NotifyingAsyncQueryHandler;
import com.slandete.android.apps.campussched.util.UIUtils;
import com.slandete.android.apps.campussched.util.NotifyingAsyncQueryHandler.AsyncQueryListener;
...
public class HomeActivity extends Activity implements AsyncQueryListener,
    ...
    public void onTVClick(View v) {
        startActivity(new Intent(Intent.ACTION_VIEW, UIUtils.TV_URL));
    }
    ...
    private void reloadNowPlaying(boolean forceRelocate) {
        ...
        if (currentTimeMillis < UIUtils.CONFERENCE_START_MILLIS) {
      	  ...
      	  if (Setup.USE_WIFI_CHECK){
              nowPlaying = createNowPlayingDuringViewByWiFi(forceRelocate);
      	  }else{
    ...
    private View createNowPlayingDuringView(boolean forceRelocate) {
       ...
       TextView nowPlayingSubTitle = (TextView) nowPlaying.findViewById(
             R.id.now_playing_subtitle);

       mCountdownTextView = nowPlayingTitle;
       //mMessageHandler.post(mCountdownRunnable);
       mNowPlayingLoadingView.setVisibility(View.GONE);
       nowPlaying.setVisibility(View.VISIBLE);
       mCountdownTextView.setText(getString(R.string.now_playing_title));
       
       nowPlayingSubTitle.setText(getString(R.string.now_playing_subtitle2));

       return nowPlaying;
   }
    
    private View createNowPlayingDuringViewByWiFi(boolean forceRelocate) {
