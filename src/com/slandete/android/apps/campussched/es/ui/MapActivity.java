...
public class MapActivity extends Activity {
     ...
     */
    public static final String EXTRA_ROOM = "com.slandete.android.apps.campussched.extra.ROOM";

    public static final String OFFICE_HOURS_ROOM_ID = "officehours";

    private static final String MAP_JSI_NAME = "MAP_CONTAINER";
    private static final String MAP_URL = "http://www.campuseros.net/wp-content/uploads/2011/03/cpes15-plano-v2.jpg";
